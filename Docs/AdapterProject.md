...
**Current core:** `0.9.0-beta` (32/32 suites; 0.8.1 was tagged
...
current core is 0.9.0-beta, 32/32 suites green. Two things changed
...
current core is 0.9.0-beta, 32/32 suites. All seven stones of the
