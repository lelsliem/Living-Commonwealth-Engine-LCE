...
**Current core:** `0.8.5-alpha` (32/32 suites; 0.8.1 was tagged
...
current core is 0.8.5-alpha, 32/32 suites green. Two things changed
...
current core is 0.8.5-alpha, 32/32 suites. All seven stones of the
